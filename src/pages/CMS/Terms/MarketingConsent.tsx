  ...
  const loadDocument = useCallback(async () => {
    try {
      ...
      if (activeDoc) {
        ...
        devLog("마케팅 활용 동의 문서 로딩:", activeDoc);
      } else {
        setCurrentDocument(null);
        setContent("");
        devLog("새 마케팅 활용 동의 문서 생성 준비");
      }
    } catch (err: any) {
      devLog("마케팅 활용 동의 문서 로딩 실패:", err);
    ...
    try {
      ...
      if (currentDocument) {
        ...
        if (updatedDoc) {
          ...
          toast.success("마케팅 활용 동의가 성공적으로 수정되었습니다!");
        }
      } else {
        // 새 문서 생성
        ...
        toast.success("마케팅 활용 동의가 성공적으로 저장되었습니다!");
      }

      await loadDocument();
    } catch (err: any) {
      devLog("마케팅 활용 동의 저장 실패:", err);
      ...
      <EditorContainer>
        {isLoading ? (
          ...
          <CustomTiptapEditor
            ...
            key={`marketing-consent-${currentDocument?.id || 'new'}`}
